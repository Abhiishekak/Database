...
html { 
margin:0;
  background: url(temple39.jpg) no-repeat center fixed; 
...
<div>
<h2><font color="white">Date and Time</font></h2></div>
...
ps1.executeUpdate("create trigger user_trigs17 before insert on employee for each row insert into trigger_time4 values(now())");


Statement ps=con.createStatement();
ResultSet rs=ps.executeQuery("select * from trigger_time4");
while(rs.next())
{
%>
<tr bgcolor="yellow">
