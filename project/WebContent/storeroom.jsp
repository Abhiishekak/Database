...
<%
String itid=request.getParameter("cn");
String iname=request.getParameter("cp");
String qty=request.getParameter("cq");
int qt=Integer.parseInt(qty);
String pid=request.getParameter("cr");
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/temple52","root","abhiak");
PreparedStatement ps=con.prepareStatement("insert into storeroom values(?,?,?,?)");
ps.setString(1,itid);
