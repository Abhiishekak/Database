...
String cost=request.getParameter("cp");
int ct=Integer.parseInt(cost);
String sale=request.getParameter("cq");
int se=Integer.parseInt(sale);
String amt=request.getParameter("cr");
