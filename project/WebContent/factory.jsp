...
<%
String prid=request.getParameter("cn");
String prname=request.getParameter("cp");
String total=request.getParameter("cq");
String date=request.getParameter("cr");
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/temple52","root","abhiak");
PreparedStatement ps=con.prepareStatement("insert into factory values(?,?,?,?)");
ps.setString(1,prid);
